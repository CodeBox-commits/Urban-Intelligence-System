...
DATASETS = {
    ...
    "resource": {
        "path": DATA_DIR / "resource_synthetic.csv",
        "target": "anomaly",
        "categorical": [],
        "output_path": MODEL_DIR / "resource_model.pkl",
        "candidates": [
            {"n_estimators": 140, "max_depth": 8, "min_samples_leaf": 10, "max_features": 0.8},
            {"n_estimators": 180, "max_depth": 12, "min_samples_leaf": 8, "max_features": "sqrt"},
            {"n_estimators": 220, "max_depth": 14, "min_samples_leaf": 6, "max_features": 0.7},
        ],
    },
}
